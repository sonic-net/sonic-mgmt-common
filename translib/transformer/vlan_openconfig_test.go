...
// 	url = "/openconfig-interfaces:interfaces/interface[name=PortChannel12]/openconfig-if-aggregate:aggregation/openconfig-vlan:switched-vlan/config"
// 	expected_get_json = "{\"openconfig-vlan:config\":{\"interface-mode\":\"TRUNK\",\"trunk-vlans\":[30,10]}}"
// 	t.Run("Test GET VLAN member config ", processGetRequest(url, nil, expected_get_json, false))
// 	time.Sleep(1 * time.Second)
...
// 	t.Log("\n\n--- Verify VLAN member (PC, access) ---")
// 	url = "/openconfig-interfaces:interfaces/interface[name=PortChannel12]/openconfig-if-aggregate:aggregation/openconfig-vlan:switched-vlan/config"
// 	expected_get_json = "{\"openconfig-vlan:config\":{\"access-vlan\":20,\"interface-mode\":\"TRUNK\",\"trunk-vlans\":[30,10]}}"
// 	t.Run("Test GET VLAN member config ", processGetRequest(url, nil, expected_get_json, false))
// 	time.Sleep(1 * time.Second)
...
// 	t.Log("\n\n--- PATCH to add VLAN member (Eth, access) ---")
// 	url = "/openconfig-interfaces:interfaces/interface[name=Ethernet8]/openconfig-if-ethernet:ethernet/openconfig-vlan:switched-vlan/config"
// 	url_input_body_json = "{\"openconfig-vlan:config\":{\"interface-mode\":\"ACCESS\",\"access-vlan\":10}}"
// 	t.Run("Test add VLAN member", processSetRequest(url, url_input_body_json, "PATCH", false, nil))
// 	time.Sleep(1 * time.Second)

// 	t.Log("\n\n--- PATCH VLAN member (Eth, interface-mode leaf) ---")
// 	url = "/openconfig-interfaces:interfaces/interface[name=Ethernet8]/openconfig-if-ethernet:ethernet/openconfig-vlan:switched-vlan/config/interface-mode"
...
// 	url = "/openconfig-interfaces:interfaces/interface[name=Ethernet0]/openconfig-if-ethernet:ethernet/openconfig-vlan:switched-vlan"
// 	expected_get_json = "{\"openconfig-vlan:switched-vlan\":{\"config\":{\"interface-mode\":\"TRUNK\",\"trunk-vlans\":[30,40]},\"state\":{\"interface-mode\":\"TRUNK\",\"trunk-vlans\":[30,40]}}}"
// 	t.Run("Test GET VLAN member config ", processGetRequest(url, nil, expected_get_json, false))
// 	time.Sleep(1 * time.Second)

// 	t.Log("\n\n--- DELETE VLAN member (Eth, one trunk) ---")
// 	url = "/openconfig-interfaces:interfaces/interface[name=Ethernet0]/openconfig-if-ethernet:ethernet/openconfig-vlan:switched-vlan/config/trunk-vlans=40"
// 	t.Run("Test delete VLAN member", processDeleteRequest(url, true))
// 	time.Sleep(1 * time.Second)

// 	t.Log("\n\n--- Verify deleted VLAN member (Eth, one trunk) ---")
// 	url = "/openconfig-interfaces:interfaces/interface[name=Ethernet0]/openconfig-if-ethernet:ethernet/openconfig-vlan:switched-vlan"
// 	expected_get_json = "{\"openconfig-vlan:switched-vlan\":{\"config\":{\"interface-mode\":\"TRUNK\",\"trunk-vlans\":[30]},\"state\":{\"interface-mode\":\"TRUNK\",\"trunk-vlans\":[30]}}}"
// 	t.Run("Test GET VLAN member config ", processGetRequest(url, nil, expected_get_json, false))
// 	time.Sleep(1 * time.Second)
...
// 	url = "/openconfig-interfaces:interfaces/interface[name=PortChannel12]/openconfig-if-aggregate:aggregation/openconfig-vlan:switched-vlan/config/trunk-vlans=10"
// 	t.Run("Test delete VLAN member", processDeleteRequest(url, true))
// 	time.Sleep(1 * time.Second)
