...
func TestCPU_SumV4Counters_AllFields(t *testing.T) {
	...
	if *parent1.InPkts != 15 || *parent1.OutPkts != 15 {
		t.Errorf("sumV4Counters failed addition: got InPkts=%d, OutPkts=%d", *parent1.InPkts, *parent1.OutPkts)
	}
	...
	if *parent2.InPkts != 5 || *parent2.OutPkts != 5 {
		t.Errorf("sumV4Counters failed assignment: got InPkts=%d, OutPkts=%d", *parent2.InPkts, *parent2.OutPkts)
	}
}
...
func TestCPU_SumV6Counters_AllFields(t *testing.T) {
	...
	if *parent1.InPkts != 30 || *parent1.OutPkts != 30 ||
		*parent1.InDiscardedPkts != 30 || *parent1.OutDiscardedPkts != 30 {
		t.Errorf("sumV6Counters failed addition: got InPkts=%d, OutPkts=%d, InDiscardedPkts=%d, OutDiscardedPkts=%d",
			*parent1.InPkts, *parent1.OutPkts, *parent1.InDiscardedPkts, *parent1.OutDiscardedPkts)
	}
	...
	if *parent2.InPkts != 10 || *parent2.OutPkts != 10 ||
		*parent2.InDiscardedPkts != 10 || *parent2.OutDiscardedPkts != 10 {
		t.Errorf("sumV6Counters failed assignment: got InPkts=%d, OutPkts=%d, InDiscardedPkts=%d, OutDiscardedPkts=%d",
			*parent2.InPkts, *parent2.OutPkts, *parent2.InDiscardedPkts, *parent2.OutDiscardedPkts)
	}
}
