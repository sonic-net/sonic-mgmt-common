...
func Test_openconfig_loopback_interfaces(t *testing.T) {
	...
	expected_get_json := "{\"openconfig-interfaces:config\": {\"name\": \"Loopback11\", \"enabled\": true, \"type\": \"iana-if-type:softwareLoopback\"}}"
	...
	expected_get_json = "{\"openconfig-interfaces:config\": {\"name\": \"Loopback22\", \"enabled\": true, \"type\": \"iana-if-type:softwareLoopback\"}}"
	t.Run("Test GET Loopback interface creation config ", processGetRequest(url, nil, expected_get_json, false))
	time.Sleep(1 * time.Second)
	...
	url = "/openconfig-interfaces:interfaces/interface[name=Loopback100]"
	expected_get_json = "{\"openconfig-interfaces:interface\":[{ \"config\": {\"name\": \"Loopback100\", \"enabled\": true, \"type\": \"iana-if-type:softwareLoopback\"}, \"state\": {\"name\": \"Loopback100\",\"cpu\": false,\"logical\": true,\"management\": false,\"type\": \"iana-if-type:softwareLoopback\"}, \"name\": \"Loopback100\", \"subinterfaces\": {\"subinterface\": [{\"config\": {\"index\": 0}, \"index\": 0, \"state\": {\"index\": 0}}]}}]}"
...
func Test_openconfig_loopback_ipv6_ipv4_addresses(t *testing.T) {
	...
	expected_get_json := "{\"openconfig-interfaces:config\": {\"name\": \"Loopback14\", \"enabled\": true, \"type\": \"iana-if-type:softwareLoopback\"}}"
	t.Run("Test GET Loopback interface creation config ", processGetRequest(url, nil, expected_get_json, false))
	time.Sleep(1 * time.Second)
	...
	expected_get_json = "{\"openconfig-interfaces:config\": {\"name\": \"Loopback15\", \"enabled\": true, \"type\": \"iana-if-type:softwareLoopback\"}}"
	t.Run("Test GET Loopback interface creation config ", processGetRequest(url, nil, expected_get_json, false))
	time.Sleep(1 * time.Second)
	...
	expected_get_json = "{\"openconfig-interfaces:config\": {\"name\": \"Loopback21\", \"enabled\": true, \"type\": \"iana-if-type:softwareLoopback\"}}"
	t.Run("Test GET Loopback interface creation config ", processGetRequest(url, nil, expected_get_json, false))
	time.Sleep(1 * time.Second)
