...
var Subscribe_intf_get_counters_xfmr SubTreeXfmrSubscribe = func(inParams XfmrSubscInParams) (XfmrSubscOutParams, error) {
	log.Info("Entering Subscribe_intf_get_counters_xfmr")
	...
	result := XfmrSubscOutParams{
		...
		nOpts:        &notificationOpts{mInterval: 1, pType: Sample},
	}

	defer log.Info("Returning Subscribe_intf_get_counters_xfmr, result:", result)
...
var Subscribe_intf_get_ether_counters_xfmr SubTreeXfmrSubscribe = func(inParams XfmrSubscInParams) (XfmrSubscOutParams, error) {
	...
	log.Infof("Returning Subscribe_intf_get_ether_counters_xfmr, result.dbDataMap=%v", result.dbDataMap)
